...
import com.example.cinemaapp.Schedule.DieuKhoanActivity;
...
public class ThanhToanActivity2 extends AppCompatActivity {
    ...
    private ArrayList<DatDoAnActivity2.Combo> danhSachCombo = new ArrayList<>();
    ...
    private final BroadcastReceiver timerTickReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if (TimerService.ACTION_TIMER_TICK.equals(intent.getAction())) {
                long remainingTime = intent.getLongExtra(com.example.cinemaapp.Schedule.TimerService.EXTRA_TIME_REMAINING, 0);
                ...
                Toast.makeText(ThanhToanActivity2.this, "Đã hết thời gian.", Toast.LENGTH_LONG).show();
                finish();
            }
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        termsLinkTextView.setOnClickListener(v -> {
            Intent intent = new Intent(ThanhToanActivity2.this, DieuKhoanActivity.class);
        ...
        if (extras != null) {
            ...
            ArrayList<DatDoAnActivity2.Combo> comboList = (ArrayList<DatDoAnActivity2.Combo>) extras.getSerializable("danhSachCombo");
            if (comboList != null) {
                danhSachCombo.addAll(comboList);
                for (DatDoAnActivity2.Combo combo : danhSachCombo) {
        ...
        completePaymentButton.setOnClickListener(v -> {
            if (termsConditionsCheckbox.isChecked() && isPaymentMethodSelected) {
                ...
                Toast.makeText(ThanhToanActivity2.this, "Thanh toán bằng " + selectedPaymentMethod + " hoàn tất!", Toast.LENGTH_SHORT).show();
                ...
                if (!termsConditionsCheckbox.isChecked()) {
                    Toast.makeText(ThanhToanActivity2.this, "Vui lòng đồng ý với các điều khoản.", Toast.LENGTH_SHORT).show();
                } else if (!isPaymentMethodSelected) {
                    Toast.makeText(ThanhToanActivity2.this, "Vui lòng chọn một phương thức thanh toán.", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(ThanhToanActivity2.this, "Vui lòng chọn phương thức thanh toán và đồng ý với điều khoản.", Toast.LENGTH_SHORT).show();
                }
            }
        });
