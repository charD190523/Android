...
public class DatDoAnActivity2 extends AppCompatActivity {
    ...
    private final BroadcastReceiver timerTickReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if (TimerService.ACTION_TIMER_TICK.equals(intent.getAction())) {
                ...
                Toast.makeText(DatDoAnActivity2.this, "Đã hết thời gian.", Toast.LENGTH_LONG).show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnHoanTatChonGhe.setOnClickListener(v -> {
            ...
            Intent intentThanhToan = new Intent(DatDoAnActivity2.this, ThanhToanActivity2.class);
