...
public class HanoiFragment1 extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        theaterList = Arrays.asList(
                new Theater1("BHD Star Garden",idPhim, tenPhim, imageUrl, ngayChieu, gioChieuList),
                new Theater1("BHD Star Phạm Ngọc Thạch", idPhim, tenPhim, imageUrl, ngayChieu,gioChieuList),
                new Theater1("BHD Star Discovery", idPhim, tenPhim, imageUrl, ngayChieu,gioChieuList)
        );

        // Set adapter cho RecyclerView
        adapter = new TheaterAdapter1(
