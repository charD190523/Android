...
public class ChonGheActivity2 extends AppCompatActivity {
    ...
    private final BroadcastReceiver timerTickReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if (TimerService.ACTION_TIMER_TICK.equals(intent.getAction())) {
                ...
                Toast.makeText(ChonGheActivity2.this, "Đã hết thời gian đặt vé", Toast.LENGTH_LONG).show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnHoanTatChonGhe.setOnClickListener(v -> {
            if (!gheDaChon.isEmpty()) {
                ...
                Intent intentToDatDoAn = new Intent(ChonGheActivity2.this, DatDoAnActivity2.class); // Khai báo với tên khác
                ...
                Toast.makeText(ChonGheActivity2.this, "Vui lòng chọn ghế.", Toast.LENGTH_SHORT).show();
            }
        });
    }
            ...
            if (!isCurrentlyBooked) {
                if (isCoupleSeat) {
                    ...
                    if (!ghe1DaChon && !ghe2DaChon) {
                        ...
                        Toast.makeText(ChonGheActivity2.this, "Vui lòng chọn cả cặp ghế đôi.", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    // Xử lý ghế đơn
                ...
                Toast.makeText(ChonGheActivity2.this, "Ghế này đã được đặt", Toast.LENGTH_SHORT).show();
            }
        });
