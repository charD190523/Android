...
public class LichChieuHueFragment extends Fragment {

    private RecyclerView rapRecyclerView;
    private RapAdapter rapAdapter;
    private List<String> danhSachRapHue;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_lich_chieu_hue, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // Dữ liệu rạp cho Huế
        danhSachRapHue = new ArrayList<>();
        danhSachRapHue.add("BHD Star Huế");
        // ...

        // Thiết lập RecyclerView và Adapter
        rapRecyclerView.setLayoutManager(new LinearLayoutManager(requireContext()));
        rapAdapter = new RapAdapter(requireContext(), danhSachRapHue, tenPhim, thoiLuong, anhBiaPhim);
